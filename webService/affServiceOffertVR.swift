//
//  affServiceOffertVR.swift
//  webService
//
//  Created by Hatem Chaabini on 12/01/2020.
...
class affServiceOffertVR:BaseViewController,UITableViewDataSource,UITableViewDelegate  {
    var tvShows:NSArray = []
    ...
    func fetchTvShows(){
                     ...
                     Alamofire.request("http://localhost:3000/affServiceOffertValideretrefuser/"+k).responseJSON{
